...
curl -fsSL https://raw.githubusercontent.com/tsirysndr/smolsonic/main/install.sh \
  | SMOLSONIC_VERSION=v0.6.3 SMOLSONIC_INSTALL=$HOME/.local/bin sh
```
...
curl -fsSLO https://github.com/tsirysndr/smolsonic/releases/latest/download/smolsonic_0.6.3_amd64.deb
sudo dpkg -i smolsonic_0.6.3_amd64.deb
```
...
curl -fsSLO https://github.com/tsirysndr/smolsonic/releases/latest/download/smolsonic-0.6.3-1.x86_64.rpm
sudo rpm -i smolsonic-0.6.3-1.x86_64.rpm
```
